    ...
    <div className="bg-[#FAF8F5] text-[#1F2022] border-b border-[#E5E1D8] shadow-sm">
      ...
      <div className="bg-[#F3F0EA] px-4 py-1.5 border-b border-[#E5E1D8] text-xs flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 px-2 py-0.5 rounded bg-emerald-50 border border-emerald-200 text-[10px] font-mono text-emerald-800" title="Firebase Firestore Real-time Cloud Synchronization Active">
